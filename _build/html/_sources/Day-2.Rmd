...
```{r}
data <- read.csv("datasets/water_potability.csv")
...
```{r}
heart <- read.csv("datasets/healthcare-dataset-stroke-data.csv", stringsAsFactors=TRUE)
...
```{r}
diamonds <- read.csv("datasets/diamonds.csv", header = T, stringsAsFactors = T)
